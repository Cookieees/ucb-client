...
api_instance = ucb_client.BuildsApi(ucb_client.ApiClient(configuration))
orgid = 'orgid_example' # str | Organization identifier
projectid = 'projectid_example' # str | Project identifier
options = ucb_client.Options8() # Options8 | Options to specify what builds to delete
...
buildtargetid = 'buildtargetid_example' # str | unique id auto-generated from the build target name
number = 'number_example' # str | Build number or in some cases _all
share_expiry = ucb_client.ShareExpiry1() # ShareExpiry1 | Date when share link will expire (optional)
...
Retrieve the plain text log for a specific build.  Please note that this route will normally redirect with a 303 code to the build log for a completed job, so it is important to follow redirects.
...
buildtargetid = 'buildtargetid_example' # str | unique id auto-generated from the build target name
number = 'number_example' # str | Build number or in some cases _all
share_expiry = ucb_client.ShareExpiry() # ShareExpiry | Date when share link will expire (optional)
...
projectid = 'projectid_example' # str | Project identifier
buildtargetid = 'buildtargetid_example' # str | unique id auto-generated from the build target name
options = ucb_client.Options9() # Options9 | Options for starting the builds. You can specify a platform and label only when starting a local (_local) build. A local build will return immediately and be marked as successful.  (optional)
...
buildtargetid = 'buildtargetid_example' # str | unique id auto-generated from the build target name
number = 'number_example' # str | Build number or in some cases _all
options = ucb_client.Options10() # Options10 | Options for build update
