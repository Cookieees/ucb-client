...
api_instance = ucb_client.BuildtargetsApi(ucb_client.ApiClient(configuration))
orgid = 'orgid_example' # str | Organization identifier
projectid = 'projectid_example' # str | Project identifier
options = ucb_client.Options6() # Options6 | Options for build target create/update
...
projectid = 'projectid_example' # str | Project identifier
buildtargetid = 'buildtargetid_example' # str | unique id auto-generated from the build target name
options = ucb_client.Options7() # Options7 | Options for build target create/update
